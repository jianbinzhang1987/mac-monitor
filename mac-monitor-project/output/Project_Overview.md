...
- **[NEW] HTTP Proxy Mode**: Independent user-space proxy (`traffic-proxy`) for environments where TUN mode is restricted. Supports full HTTPS MITM and auto-configuration via `vpn-helper`.
